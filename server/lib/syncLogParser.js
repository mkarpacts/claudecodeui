// Parses /repos/sync.log written by scripts/git-sync/sync-repos.sh into a
// status object for the Settings → Source Code Sync tab.
...
export const EMPTY_STATUS = { lastCycle: null, nextSyncIn: null, nextSyncAt: null, repos: [], running: false };
...
export function parseSyncLog(content) {
  ...
  return {
    ...
    nextSyncIn: nextSyncInterval,
    nextSyncAt,
    repos,
    running: currentCycle !== null,
  };
}
